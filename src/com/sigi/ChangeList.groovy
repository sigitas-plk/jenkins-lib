...
class ChangeList implements Serializable {
    ...
    static List<Map> getTitleAndTickets(String[] commits, List<String> ignore, Pattern ticketRegex = JobConstants.jiraTicketRegex) {
    ...
    static boolean shouldIncludeToChangeList(title, List<String> ignoreTypes) {
